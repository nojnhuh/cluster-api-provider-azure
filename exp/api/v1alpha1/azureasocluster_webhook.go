...
func SetupAzureASOClusterWebhookWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewWebhookManagedBy(mgr, &AzureASOCluster{}).
...
func (a *azureASOClusterWebhook) ValidateCreate(_ context.Context, asoCluster *AzureASOCluster) (admission.Warnings, error) {
...
func (a *azureASOClusterWebhook) ValidateUpdate(ctx context.Context, _, asoCluster *AzureASOCluster) (admission.Warnings, error) {
	return a.ValidateCreate(ctx, asoCluster)
}

// ValidateDelete implements webhook.Validator so a webhook will be registered for the type.
func (*azureASOClusterWebhook) ValidateDelete(_ context.Context, _ *AzureASOCluster) (admission.Warnings, error) {
	return nil, nil
}
