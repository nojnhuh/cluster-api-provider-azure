...
func SetupAzureASOMachineTemplateWebhookWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewWebhookManagedBy(mgr, &AzureASOMachineTemplate{}).
...
func (a *azureASOMachineTemplateWebhook) ValidateCreate(_ context.Context, asoMachineTemplate *AzureASOMachineTemplate) (admission.Warnings, error) {
...
func (a *azureASOMachineTemplateWebhook) ValidateUpdate(ctx context.Context, _, asoMachineTemplate *AzureASOMachineTemplate) (admission.Warnings, error) {
	return a.ValidateCreate(ctx, asoMachineTemplate)
}

// ValidateDelete implements webhook.Validator so a webhook will be registered for the type.
func (*azureASOMachineTemplateWebhook) ValidateDelete(_ context.Context, _ *AzureASOMachineTemplate) (admission.Warnings, error) {
	return nil, nil
}
