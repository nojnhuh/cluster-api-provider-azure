...
func (a *azureASOMachineWebhook) ValidateCreate(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	var allErrs field.ErrorList

	asoMachine, ok := obj.(*AzureASOMachine)
	if !ok {
		return nil, apierrors.NewBadRequest("expected an AzureASOMachine")
	}
...
func (a *azureASOMachineWebhook) ValidateUpdate(ctx context.Context, _, obj runtime.Object) (admission.Warnings, error) {
	return a.ValidateCreate(ctx, obj)
}

// ValidateDelete implements webhook.Validator so a webhook will be registered for the type.
func (*azureASOMachineWebhook) ValidateDelete(_ context.Context, _ runtime.Object) (admission.Warnings, error) {
	return nil, nil
}
