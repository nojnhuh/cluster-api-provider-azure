...
// +kubebuilder:rbac:groups=network.azure.com,resources=natgateways;virtualnetworkssubnets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.azure.com,resources=natgateways/status;virtualnetworkssubnets/status,verbs=get;list;watch
