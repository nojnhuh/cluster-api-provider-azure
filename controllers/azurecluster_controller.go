...
// +kubebuilder:rbac:groups=network.azure.com,resources=natgateways;virtualnetworks;virtualnetworkssubnets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.azure.com,resources=natgateways/status;virtualnetworks/status;virtualnetworkssubnets/status,verbs=get;list;watch
