...
// +kubebuilder:rbac:groups=network.azure.com,resources=natgateways;bastionhosts;virtualnetworks;virtualnetworkssubnets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.azure.com,resources=natgateways/status;bastionhosts/status;virtualnetworks/status;virtualnetworkssubnets/status,verbs=get;list;watch
